...
3. `docs/REGLAS_NEGOCIO.md`
4. `docs/DECISIONES_PENDIENTES.md`

Para pruebas/conexiones trabaja sobre `ready/clone-test-connect-v1` o una rama hija aislada. No promociones `main` por iniciativa propia.
